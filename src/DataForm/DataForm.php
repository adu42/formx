...
namespace Ado\Formx\DataForm;

use Illuminate\Database\Eloquent\Model;
use Ado\Formx\DataForm\Field\Auto;
use Ado\Formx\DataForm\Field\Autocomplete;
use Ado\Formx\DataForm\Field\Colorpicker;
use Ado\Formx\DataForm\Field\Date;
use Ado\Formx\DataForm\Field\Field;
use Ado\Formx\DataForm\Field\File;
use Ado\Formx\DataForm\Field\Hidden;
use Ado\Formx\DataForm\Field\Password;
use Ado\Formx\DataForm\Field\Radiogroup;
use Ado\Formx\DataForm\Field\Redactor;
use Ado\Formx\DataForm\Field\Select;
use Ado\Formx\DataForm\Field\Tags;
use Ado\Formx\DataForm\Field\Number;
use Ado\Formx\DataForm\Field\Numberrange;
use Ado\Formx\DataForm\Field\Text;
use Ado\Formx\DataForm\Field\Textarea;
use Ado\Formx\Widget;
...
class DataForm extends Widget
{
    ...
    public function add($name, $label, $type, $validation = '')
    {
        if (strpos($type, "\\") !== false) {
            ...
            $field_class = '\Ado\Formx\DataForm\Field\\' .  ucfirst($type);
        }
    ...
    {
        if ($name == "") $name = trans('formx::formx.reset');
     ...
     * @return \Ado\Formx\DataForm\Field $field
     */
    ...
    public function build($view = '')
    {
        if (isset($this->attributes['class']) and strpos($this->attributes['class'], 'form-inline') !== false) {
            $this->view = 'formx::dataform_inline';
     ...
     */
    public function view($viewname = 'formx::form', $array = [])
    {
        if (!isset($array['form'])) {
            $form = $this->getForm();
            $array['form'] = $form;
    ...
    public function __call($name, $arguments)
    {
        ...
        $classname = '\Ado\Formx\DataForm\Field\\'.ucfirst($name);
    ...
    public function setIsMultipart(){
        $this->multipart = true;
        return $this;
    }
