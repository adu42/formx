...
class Date extends Field
{
    ...
    public function __construct($name, $label, &$model = null, &$model_relations = null)
    {
        ...
        $this->format = config('formx.fields.date.format', $this->format);
    }
    ...
    public function build()
    {
        ...
        switch ($this->status) {
            ...
            case "modify":
             ...
             /*   Formx::css('datepicker/datepicker3.css');
                Formx::js('datepicker/bootstrap-datepicker.js');
                if ($this->language != "en") {
                    Formx::js('datepicker/locales/bootstrap-datepicker.'.$this->language.'.js');
                }
             */
