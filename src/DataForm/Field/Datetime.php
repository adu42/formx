...
class Datetime extends Field
{
    ...
    public function __construct($name, $label, &$model = null, &$model_relations = null)
    {
        ...
        $this->format = config('formx.fields.datetime.format', $this->format);
        $this->store_as = config('formx.fields.datetime.store_as', $this->store_as);
    ...
    public function build()
    {
        ...
        switch ($this->status) {
            ...
            $this->attributes['readonly']="true";
             /*
                Formx::css('datetimepicker/datetimepicker3.css');
                Formx::js('datetimepicker/bootstrap-datetimepicker.js');
                if ($this->language != "en") {
                    Formx::js('datetimepicker/locales/bootstrap-datetimepicker.'.$this->language.'.js');
                }
                */
