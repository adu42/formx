...
use Ado\Formx\Exceptions\DataSetException;
...
class DataSet extends Widget
{
    ...
    public static function source($source)
    {
        ...
        if ($ins->source instanceof \Ado\Formx\DataFilter\DataFilter) {
    ...
    public function build()
    {
        ...
        } elseif ( is_a($this->source, "\Ado\Formx\DataFilter\DataFilter")) {
           $this->type = "model";
