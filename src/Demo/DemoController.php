...
class DemoController extends Controller
{
    ...
    {
        return  view('formx::demo.demo');
    }

    public function getModels()
    {
        return  view('formx::demo.models');
    }
    ...
    public function getSchema()
    {
        ...
        return \Redirect::to("formx-demo")->with("message", "Database filled");
    }
    ...
    public function getSet()
    {
        ...
        return  view('formx::demo.set', compact('set'));
    }
    ...
    public function getGrid()
    {
        ...
        $grid->edit('/formx-demo/edit', 'Edit','show|modify');
        $grid->link('/formx-demo/edit',"New Article", "TR");
        ...
        return  view('formx::demo.grid', compact('grid'));
    }
    ...
    public function getFilter()
    {
        ...
        $grid->edit('/formx-demo/edit', 'Edit','modify|delete');
        $grid->paginate(10);

        return  view('formx::demo.filtergrid', compact('filter', 'grid'));
    }
    ...
    public function getCustomfilter()
    {
        ...
        return  view('formx::demo.customfilter', compact('filter', 'set'));
    }
    ...
    public function anyForm()
    {
        ...
        $form->saved(function () use ($form) {
            ...
            $form->link("/formx-demo/form","back to the form");
        });

        return view('formx::demo.form', compact('form'));
    }
    ...
    public function anyAdvancedform()
    {
        ...
        $form->add('author.firstname','Author','autocomplete')->remote(null, "id", "/formx-demo/authorlist");
        ...
        $form->saved(function () use ($form) {
            $form->message("ok record saved");
            $form->link("/formx-demo/advancedform","back to the form");
        });

        return view('formx::demo.advancedform', compact('form'));
    }
    ...
    public function anyStyledform()
    {
        ...
        $form->saved(function () use ($form) {
            $form->message("ok record saved");
            $form->link("/formx-demo/styledform","back to the form");
        });
        $form->build();

        return view('formx::demo.styledform', compact('form'));
    }
    ...
    public function anyEdit()
    {
        ...
        $edit->link("formx-demo/filter","Articles", "TR")->back();
        ...
        return $edit->view('formx::demo.edit', compact('edit'));
    ...
    public function anyDatatree()
    {
        ...
        $tree->add('title');
        $tree->edit("/formx-demo/menuedit", 'Edit', 'modify|delete');
        $tree->submit('Save the order');

        return view('formx::demo.tree', compact('tree'));
    }
    ...
    public function anyMenuedit()
    {
        ...
        $edit->link("formx-demo/datatree","Menu", "TR")->back();
    ...
    public function getNudegrid()
    {
        ...
        $grid->add('id','ID', true)->style("width:70px");
        $grid->add('title','Title', true);
        $grid->edit('/formx-demo/nudeedit', 'Edit','modify|delete');
        $grid->paginate(10);
        return $grid;
    }
    ...
    public function anyNudeedit()
    {
        ...
        $edit = \DataEdit::source(new Article());
        $edit->link("formx-demo/nudegrid","Articles", "TR");
        $edit->label('Edit Article');
        $edit->add('title','Title', 'text')->rule('required|min:5');
        $edit->add('public','Public','checkbox');
        return $edit->view();
    ...
    public function getEmbed()
    {
        ...
        $embed1 = \DataEmbed::source('/formx-demo/nudegrid', 'embed1')->build();

        //if you prefer you can simply use an html tag
        $embed2 = '<dataembed id="embed2" remote="/formx-demo/nudeedit?modify=1"></dataembed>';
        
        return view('formx::demo.embed', compact('embed1','embed2'));
    }
