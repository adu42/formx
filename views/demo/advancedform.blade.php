...
@section('body')
    ...
    <p>
        ...
        <ul>
         ...
         <li>The second one is the smarter, using relation.fieldname as fieldname and <strong>search(array of search fields)</strong><br />
             formx will manage an ajax request to instace a related entity, search on search fields, and store the foreign key on select
         </li>
    ...
    <p>
        ...
        {!! $form !!}
        {!! Documenter::showMethod("Ado\\Formx\\Demo\\DemoController", array("anyAdvancedform", "getAuthorlist")) !!}
    </p>
@stop
